...
export function InteractiveTrendChart({
  ...
  return (
    <div className="interactive-chart-shell">
      <svg className="mini-line-chart interactive-trend-chart" viewBox="0 0 520 170" role="img" aria-label={ariaLabel}>
        ...
        {points.map((point, index) => {
          ...
          return (
            ...
            >
              <circle cx={point.x} cy={point.y} r="12" className="line-chart-hit" />
              <circle cx={point.x} cy={point.y} r="4" className="line-chart-point" />
              <text x={point.x} y="164" textAnchor="middle" className="line-chart-label">
                {point.label}
              </text>
            </g>
          );
