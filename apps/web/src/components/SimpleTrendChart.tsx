...
export function SimpleTrendChart({ ariaLabel, data }: SimpleTrendChartProps) {
  const width = 520;
  const height = 170;
  const padding = 22;
  ...
  return (
    <svg className="mini-line-chart" viewBox={`0 0 ${width} ${height}`} role="img" aria-label={ariaLabel}>
