...
public sealed class SalesController : ControllerBase
{
    ...
    {
        return Ok(_salesAnalyticsService.GetTimeBreakdown(level, year, quarter, stateMemberUniqueName, cityMemberUniqueName));
    }
    ...
    public ActionResult<SalesPivotResponse> GetPivot(
        ...
        [FromQuery] string? cityMemberUniqueName = null)
    {
        return Ok(_salesAnalyticsService.GetPivot(timeLevel, year, quarter, storeLevel, stateMemberUniqueName, cityMemberUniqueName));
    }
}
